...
( function( $, api ) {
	...
	api.selectiveRefresh.bind( 'partial-content-rendered', function( placement ) {
		...
		$( document ).ready( function() {
			...
			$( '.main-navigation .sub-menu' ).before( '<button class="sub-menu-toggle" role="button" aria-expanded="false">' + Caspianl10n.expandMenu + Caspianl10n.collapseMenu + Caspianl10n.subNav + '</button>' );
